...
function hasProperty(obj, property) {
  ...
  if (property in obj) { return `Property ${property} exists ` } else { return `Property ${property} does not exist` };
...
function printKeysAndValues(obj) {
  for (const keys in obj) {
    // console.log(`key: ${keys}, value: ${obj} `);
...
function printProductDetails(obj) {
  const { price, productName, manufacturer: { companyName, country } } = obj;
